...
import { Video, Lock, Mail, User as UserIcon, ArrowRight, Loader2, UserCheck } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#101416] text-[#E0E3E6] px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Create your free account</h1>
          <p className="text-xs text-gray-400">Join Zoom One for HD video conferencing and meeting history.</p>
        </div>
        ...
        <p className="text-center text-xs text-gray-400">
          ...
          <Link href="/login" className="text-[#2D8CFF] font-bold hover:underline">
            Sign In
          </Link>
        </p>
      </div>
