    ...
    <div className="relative w-full h-full bg-zoom-cardBg rounded-xl overflow-hidden border border-zoom-border/80 shadow-md flex items-center justify-center group">
      {!isVideoOff && stream ? (
        <video
          ...
          autoPlay
          playsInline
          muted={isLocal} // Avoid local feedback loop
      ...
      {/* Overlay label */}
      <div className="absolute bottom-3 left-3 bg-black/60 backdrop-blur-md px-3 py-1 rounded-lg flex items-center gap-2 border border-white/10">
